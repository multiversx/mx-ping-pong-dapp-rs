...
use multiversx_my_sc_scenario::api::{SingleTxApi, StaticApi};
...
fn world() -> multiversx_my_sc_scenario::ScenarioWorld {
    let mut blockchain = multiversx_my_sc_scenario::ScenarioWorld::new();
