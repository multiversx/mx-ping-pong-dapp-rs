...
impl<M: ManagedTypeApi> From<crate::multiversx_sc::types::AnnotatedEgldPayment<M>>
    for BigUintValue
{
    fn from(from: crate::multiversx_sc::types::AnnotatedEgldPayment<M>) -> Self {
        BigUintValue {
